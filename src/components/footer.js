        ...
        <div>
            <div className="bg-white flex justify-between">
                <div className="ml-4 mb-4 relative">
                    <a href="https://github.com/shirazhashmi/shirazhashmi.github.io" className="absolute bottom-0">
                ...
                <div className="p-10 text-right flex flex-col gap-2">
                    ...
                    <div className="flex gap-4 flex-row-reverse">
                        ...
                        <div>shirazhashmi@live.com</div>
                    </div>
                    <a href="https://github.com/shirazhashmi">
                        <div className="flex gap-4 flex-row-reverse">
                            <div>
                            <svg
                ...
                <div className="flex justify-center pb-3" style={{wordSpacing:'3px'}}>
                    ...
                    by <span className="font-bold">shiraz; </span>
                </div>
